...
class Solution {
    public int minFlips(String s) {
        ...
        StringBuilder s1 = new StringBuilder();   // 010101010101
        StringBuilder s2 = new StringBuilder();   // 101010101010
        ...
        while(right < 2 * n){
            ...
            if(s.charAt(right % n) != s1.charAt(right)){
                flip1++;
            }

            if(s.charAt(right % n) != s2.charAt(right)){
                flip2++;
            }
            ...
            while(right - left + 1 > n){
                ...
                if(s.charAt(left % n) != s1.charAt(left)){
                    flip1--;
                }

                if(s.charAt(left % n) != s2.charAt(left)){
                    flip2--;
                }
